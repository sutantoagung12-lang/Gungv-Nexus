...
def main() -> int:
    ...
    health_failed = health["overall"] == "FAIL"
    ...
    document["overall"] = (
        "PASS" if not health_failed and not validation_failures else "ATTENTION"
    )
    ...
    return 1 if health_failed or validation_failures else 0
